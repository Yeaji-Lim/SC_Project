...
<%@page import="java.util.List, silver.web.board.vo.NoticeBoardVO" %>
<%
...
<style>
	#notiList{position:relative; width:600px; height:auto; margin:0 auto; margin-top:255px;}
			...
			<table width="556" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				<td align="right"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<%
						if(login != null && login.getNickname().equals("운영자")){
					%>  
					  	
		
					 	<td width="241" align="right"> <img src="images/but_write.gif" width="56" height="21" style="cursor:pointer" onClick="javascript:location.href='writeForm.sc'">
					  	</td>
					 <%
						}else{
					 %>
