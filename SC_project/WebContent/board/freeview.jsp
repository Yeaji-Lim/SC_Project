...
<script type="text/javascript">
	...
	function del_bbs() {
		//사용자가 입력한 비밀번호 가져오기
		var fb_pwd = document.getElementById("fb_pwd").value;
	...
	function cc() {
		var d_win = document.getElementById("del_win");
			...
			<td align="right">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<img src="images/button/but_list.gif"
							width="56" height="21"
							onClick="javaScript:location.href='freelist.sc?nowPage=${nowPage}'"
							style="cursor: pointer"/> 
						
							<%
							FreeBoardVO free = (FreeBoardVO)session.getAttribute("free");
							if (free.getFb_writertel().equals(login.getName())){
							%> 
							
							<img
							src="images/button/but_modify.gif" width="56" height="21"
							onClick="javascript:location.href='freeedit.sc?fb_num=${fb_num}&nowPage=${nowPage }'"
							style="cursor: pointer"> 
							<img
							src="images/button/but_del.gif" width="56" height="21"
							onclick="openDel()" /> 
...
<%
 ...
 %>
	...
	<iframe id="check_f" border='0' width="0" height="0" frameborder='0'
	...
	<div id="del_win">
		...
		비밀번호:<input type="password" id="fb_pwd" size="7" /> <input
			type="button" value="삭제" onclick="del_bbs()" /> <input type="button"
			value="취소" onclick="cc()" />
