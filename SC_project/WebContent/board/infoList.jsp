...
<%@page import="java.util.List, silver.web.board.vo.BbsVO" %>
...
<!--주요내용시작 -->
<form name="ff2" method="post" id="infoList">
...
<!--                           </s:a> -->
						<a href="view.sc?seq=${vo.seq }&nowPage=${nowPage}"> 
							${vo.title }
						</a>
                      </td>
			  ...
			  <tr>
				<td align="right"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					  ...
					  <%if(login != null){ %>
					  <td width="241" align="right"> <img src="images/but_write.gif" width="56" height="21" style="cursor:pointer"
					  
					  onClick="javascript:location.href='infowriteForm.sc'">
					  <%}else{ %>
					   <td width="241" align="right"> <img src="images/but_write.gif" width="56" height="21" style="cursor:pointer"
