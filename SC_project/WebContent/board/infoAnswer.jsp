  ...
  <tr>
    <td valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="center"><u><b>답변달기</b></u></td>
        </tr>
        <tr>
              ...
              <tr>
                <td bgcolor="#E5E5E5"><table width="100%" border="0" cellspacing="1" cellpadding="2">
                    ...
                    <tr>
                      ...
                      <td bgcolor="#F2F7F9" align="left"> <input type="text" name="writer" readonly="readonly" value="${login_ok.name }" cssStyle="width:100px" theme="simple"/></td>
                    </tr>
