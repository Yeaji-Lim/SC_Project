...
<%@page import="java.util.List, silver.web.board.vo.QNABoardVO" %>
...
<!--주요내용시작 -->
<form name="ff2" method="post" id="qbList">
  ...
  <tr>
	<td valign="top">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		  <td align="center"><u><b>문의사항 게시판</b><u></td>
		</tr>
		<tr>
...
<!--                           </s:a> -->
						<a href="qb_view.sc?qb_num=${vo.qb_num }&nowPage=${nowPage}"> 
							${vo.qb_subject }
						</a>
                      </td>
					  <td bgcolor="#F2F7F9">${vo.qb_writer }</td>
					  <td bgcolor="#F2F7F9">${vo.qb_regdate }</td>
					  <td bgcolor="#F2F7F9">${vo.qb_readcount }</td>
					</tr>
       </c:forEach>
				...
				<td align="right"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					  ...
					  <%
					  	if(login != null){
					  %> 
					  <td width="241" align="right"> <img src="images/but_write.gif" width="56" height="21" style="cursor:pointer" onClick="javascript:location.href='qb_writeForm.sc'">
