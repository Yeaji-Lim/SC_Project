...
<%@page import="java.util.List, silver.web.board.vo.FreeBoardVO" %>
...
<!--주요내용시작 -->
<form name="ff2" method="post" id="frList">
...
<!--                           </s:a> -->
						<a href="freeview.sc?fb_num=${vo.fb_num }&nowPage=${nowPage}"> 
							${vo.fb_subject }
						</a>
                      </td>
					  <td bgcolor="#F2F7F9">${vo.fb_writertel }</td>
					  <td bgcolor="#F2F7F9">${vo.fb_regdate }</td>
					  <td bgcolor="#F2F7F9">${vo.fb_readcount }</td>
					</tr>
       </c:forEach>
			  ...
			  <tr>
				<td align="right"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					  ...
					  <td width="241" align="right"> <img src="images/but_write.gif" width="56" height="21" style="cursor:pointer" onClick="javascript:location.href='freewriteform.sc'">
					  </td>
					</tr>
				  </table></td>
			  </tr>
