...
%>
	<form action="qb_answer.sc" method="post" id="qbAns">
	
	<input type="hidden" name="nowPage" value="${vo.nowPage }"/>
	<input type="hidden" name="qb_groups" value="${vo.qb_groups }"/>
	<input type="hidden" name="qb_step" value="${vo.qb_step }"/>
	<input type="hidden" name="qb_lev" value="${vo.qb_lev }"/>
  ...
  <tr>
    <td valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="center"><u><b>문의사항 답변쓰기</b></u></td>
        </tr>
        <tr>
              ...
              <tr>
                <td align="right"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <input type="button" onclick="check(this.form)" value="답변쓰기"/>
