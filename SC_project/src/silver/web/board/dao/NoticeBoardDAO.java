...
public class NoticeBoardDAO {
	...
	public int getTotalCount(){
		return template.selectOne("noti.notice_totalCount");
	}
	//표현할 게시물 목록을 반환
	public NoticeBoardVO[] getList(Map<String, String> m){
		List<NoticeBoardVO> list = template.selectList("noti.notice_list", m);
	...
	public NoticeBoardVO getBoard(String b_idx){
		return template.selectOne("noti.notice_getBoard", b_idx);
	}
	
	public void editBbs(NoticeBoardVO vo){
		template.update("noti.notice_edit", vo);
	}
	public void delBbs(NoticeBoardVO vo){
		template.update("noti.notice_del",vo);
	}
}
