...
public class QNAListControl{
	...
	@RequestMapping("/qb_list.sc")
	public ModelAndView handleRequest(QNABoardVO vo) throws Exception {
		//현재 페이지 값 받기
		...
		QNABoardVO[] ar = qnadao.getQNAList(map);
